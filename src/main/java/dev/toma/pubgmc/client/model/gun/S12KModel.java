...
public class S12KModel extends AbstractGunModel {
    ...
    private final RendererModel s12k;
    ...
    private final RendererModel ironsights;
    ...
    public S12KModel() {
        ...
        ironsights = new RendererModel(this);
