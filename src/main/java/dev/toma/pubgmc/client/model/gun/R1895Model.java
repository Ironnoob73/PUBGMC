...
public class R1895Model extends AbstractGunModel {

    private final RendererModel drum;
    private final RendererModel bone6;
    private final RendererModel r1895;
