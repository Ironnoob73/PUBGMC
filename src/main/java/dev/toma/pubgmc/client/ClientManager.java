...
public class ClientManager {
    ...
    public static void registerEntityRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(UAZEntity.class, UAZRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(GliderEntity.class, GliderRenderer::new);
