...
public class ButtonComponent extends PressableComponent {
    ...
    public void draw(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        ...
        mc.fontRenderer.drawStringWithShadow(displayString, x + (width - w) / 2.0f, y + (height - mc.fontRenderer.FONT_HEIGHT) / 2.0f, isEnabled() ? hovered ? 0xffff00 : 0xffffff : 0xaa0000);
    }
}
