...
public abstract class AbstractFactoryBlock extends PMCBlock {
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if(!worldIn.isRemote && worldIn.getTileEntity(pos) instanceof AbstractFactoryTileEntity) {
    ...
    @Nullable
    @Override
    public abstract AbstractFactoryTileEntity createTileEntity(BlockState state, IBlockReader world);
